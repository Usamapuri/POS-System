...
UPDATE users SET profile_image_url = CASE username
  ...
  WHEN 'manager1' THEN 'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/72x72/1f603.png'
  WHEN 'server1' THEN 'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/72x72/1f604.png'
  WHEN 'server2' THEN 'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/72x72/1f601.png'
  ...
  WHEN 'store1' THEN 'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/72x72/1f917.png'
  ELSE profile_image_url
END
WHERE username IN ('admin','manager1','server1','server2','counter1','counter2','kitchen1','store1')
